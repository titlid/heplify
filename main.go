...
func createFlags() {
	...
	flag.StringVar(&ifaceConfig.PortRange, "pr", "5060-35090", "Portrange to capture SIP")
	...
	flag.StringVar(&config.Cfg.Mode, "m", "SIPRTP", "Capture modes [SIP, SIPDNS, SIPLOG, SIPRTCP]")
